function init_sidebar() {
    ...
    /**
     *  调整原代码 $SIDEBAR_MENU.find("a").on("click",)为$SIDEBAR_MENU.on("click", "a",
     * **/
...
function init_wysiwyg() {
    function b(a, b) {
        var c = "";
        "unsupported-file-type" === a ? c = "请上传图片文件 " + b: console.log("error uploading file", a, b),
            $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">&times;</button><strong></strong> ' + c + " </div>").prependTo("#alerts")
    }
